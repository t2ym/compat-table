...
(async () => {
  ...
  let browser = await puppeteer.launch({ headless: true, dumpio: true, args: ['--disable-gpu', '--no-sandbox', '--enable-logging=stderr', '--no-setsuid-sandbox'], executablePath: chromePath }); // terse and fastest
