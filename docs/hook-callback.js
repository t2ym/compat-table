...
if (hook.parameters[Symbol.for('hook-callback.js')]) {
  ...
  */
    ...
    String: {
      ...
      [S_PROTOTYPE]: {
        ...
        [S_INSTANCE]: {
          [S_CHAIN]: S_CHAIN,
          [S_DEFAULT]: 'rwxRW',
          small: '--x', // just for acl verification; Deprecated APIs can be prohibited, of course.
  ...
  const wildcardWhitelist = [
    ...
    new RegExp('^at ([^(]* [(])?' + 'https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js'),
