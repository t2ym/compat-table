if (hook.parameters[Symbol.for('bootstrap.js')]) {
  ...
  hook.parameters.bootstrapSvgScripts = `
    <script xlink:href="${new URL('hook.min.js?no-hook=true&hook-name=__hook__&context-generator-name=method&discard-hook-errors=false&fallback-page=index-fb.html&hook-property=true&hook-global=true&hook-prefix=_uNpREdiC4aB1e_&compact=true&xno-hook-authorization=', baseURI).href.replace(/\&/g, '&amp;').substring(location.origin.length) + noHookAuthorization}"></script>
  ...
  hook.parameters.importMapsJson = `{
    "imports": {
      "compat-table/": "/",
      "compat-table": "/node.js",
      "module-name": "/modules/module-name/index.js",
      "module-name/": "/modules/module-name/",
      "module-name2": "/modules/module-name2/index.js",
      "foo": "/bar.js",
